...
// $order     
// Define the sort order of results
...
// $rank     
// Define the rank of search results. Results are sorted by rank value
...
// Search in content of type reference (link) [0 | 1 ]
...
// Basic filtering : remove unwanted documents that meets the criteria of the filter
...
// chunk to style the ajaxSearch input form and layout
...
if ($cfg['ajaxSearch']){  // ajax mode
    ...
    $cfg['jsJquery'] = AS_SPATH . 'js/jquery.js';
