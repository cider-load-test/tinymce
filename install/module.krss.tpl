...
$urls[0] ="http://feeds.feedburner.com/modxsecurity";
$urls[1] = "http://feeds.feedburner.com/modx-announce";
// $urls[2] ="anotherUrlToRSS";
...
require_once($basePath.'assets/modules/krss/rss_fetch.inc');
